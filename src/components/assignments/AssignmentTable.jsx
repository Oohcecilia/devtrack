...
import { RotateCcw, FileDown, Pencil, Trash2 } from "lucide-react";
import StatusBadge from "@/components/shared/StatusBadge";
import { format } from "date-fns";

export default function AssignmentTable({ assignments, onReturn, onGenerateLetter, onEdit, onDelete }) {
  return (
